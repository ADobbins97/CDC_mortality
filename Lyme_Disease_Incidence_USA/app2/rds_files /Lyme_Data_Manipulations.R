...
state_cases_yearmap <-
  ...
  mutate(ID = tolower(ID)) %>%
  group_by(ID) %>% 
  mutate(sum_cases = sum(`2000`, `2001`, `2002`, `2003`, `2004`, `2005`, `2006`, `2007`, `2008`, `2009`, `2010`, `2011`, `2012`, `2013`, `2014`, `2015`, `2016`, `2017`)) %>% 
  select(ID, sum_cases)
...
us_cases_map2 <-
  ggplot(data = shapes2) +
  geom_sf(mapping = aes(fill = sum_cases))+
  labs(fill = "Unit", 
       title = "USA Tick Data")
...
yearly_data <- read_xlsx("rds_files /age_race_lyme_disease_data.xlsx") %>% 
  clean_names() 
